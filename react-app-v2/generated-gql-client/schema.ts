...
export interface RestEndpointEntry {
    ...
    url?: Scalars['String']
    comment?: Scalars['String']
    __typename: 'RestEndpointEntry'
}

export interface InheritedRole {
    role_name?: Scalars['String']
    role_set?: (Scalars['String'] | undefined)[]
    __typename: 'InheritedRole'
}
...
export interface RestEndpointEntryRequest{
    name?: boolean | number
    url?: boolean | number
    comment?: boolean | number
    __typename?: boolean | number
...
export interface InheritedRoleRequest{
    role_name?: boolean | number
    role_set?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface HeaderRequest{
    on_HeaderFromEnv?:HeaderFromEnvRequest,
    on_HeaderFromValue?:HeaderFromValueRequest,
    __typename?: boolean | number
}
...
export interface OperationSpecRequest{
    on_OperationSpecAllColumns?:OperationSpecAllColumnsRequest,
    on_OperationSpecIndividualColumns?:OperationSpecIndividualColumnsRequest,
    __typename?: boolean | number
}
...
const Sources_possibleTypes = ['Sources']
export const isSources = (obj?: { __typename?: any } | null): obj is Sources => {
  if (!obj?.__typename) throw new Error('__typename is missing in "isSources"')
  return Sources_possibleTypes.includes(obj.__typename)
}



const RestEndpointEntry_possibleTypes = ['RestEndpointEntry']
export const isRestEndpointEntry = (obj?: { __typename?: any } | null): obj is RestEndpointEntry => {
  if (!obj?.__typename) throw new Error('__typename is missing in "isRestEndpointEntry"')
  return RestEndpointEntry_possibleTypes.includes(obj.__typename)
}



const InheritedRole_possibleTypes = ['InheritedRole']
export const isInheritedRole = (obj?: { __typename?: any } | null): obj is InheritedRole => {
  if (!obj?.__typename) throw new Error('__typename is missing in "isInheritedRole"')
  return InheritedRole_possibleTypes.includes(obj.__typename)
}
...
export interface SourcesPromiseChain{
    name: ({get: (request?: boolean|number, defaultValue?: Scalars['String']) => Promise<Scalars['String']>}),
...
export interface SourcesObservableChain{
    name: ({get: (request?: boolean|number, defaultValue?: Scalars['String']) => Observable<Scalars['String']>}),
...
export interface RestEndpointEntryPromiseChain{
...
export interface RestEndpointEntryObservableChain{
...
export interface InheritedRolePromiseChain{
    role_name: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Promise<(Scalars['String'] | undefined)>}),
    role_set: ({get: (request?: boolean|number, defaultValue?: ((Scalars['String'] | undefined)[] | undefined)) => Promise<((Scalars['String'] | undefined)[] | undefined)>})
}

export interface InheritedRoleObservableChain{
    role_name: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Observable<(Scalars['String'] | undefined)>}),
    role_set: ({get: (request?: boolean|number, defaultValue?: ((Scalars['String'] | undefined)[] | undefined)) => Observable<((Scalars['String'] | undefined)[] | undefined)>})
}
...
export interface HasuraMetadataPromiseChain{
    ...
    sources: ({get: <R extends SourcesRequest>(request: R, defaultValue?: ((FieldsSelection<Sources, R> | undefined)[] | undefined)) => Promise<((FieldsSelection<Sources, R> | undefined)[] | undefined)>}),
...
export interface HasuraMetadataObservableChain{
    ...
    sources: ({get: <R extends SourcesRequest>(request: R, defaultValue?: ((FieldsSelection<Sources, R> | undefined)[] | undefined)) => Observable<((FieldsSelection<Sources, R> | undefined)[] | undefined)>}),
