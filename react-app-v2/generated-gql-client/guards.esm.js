...
var Sources_possibleTypes = ['Sources']
export var isSources = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isSources"')
  return Sources_possibleTypes.includes(obj.__typename)
}



var RestEndpointEntry_possibleTypes = ['RestEndpointEntry']
export var isRestEndpointEntry = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isRestEndpointEntry"')
  return RestEndpointEntry_possibleTypes.includes(obj.__typename)
}



var InheritedRole_possibleTypes = ['InheritedRole']
export var isInheritedRole = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isInheritedRole"')
